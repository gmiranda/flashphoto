 ...
 */
CImg<float>& Decoupling::bilateralFilter(const CImg<float>& I)const{
 ...
 * que nunca tendre un pixel en 1,1. CUIDADO!!!
 */
CImg<float>& Decoupling::bilateralFilterAlt(const CImg<float>& I)const{
	// La imagen J que devolvemos
 ...
 * @ToDo: usar Fast Bilateral Filter.
 */
CImg<float>& Decoupling::bilateralFilter(const CImg<float>& I, const CImg<bool>& shadow)const{
	// La imagen J que devolvemos
	CImg<float>* J = new CImg<float>(I.dimx(),I.dimy());
 ...
 * @ToDo: usar Fast Bilateral Filter.
 */
CImg<float>& Decoupling::crossBilateralFilter(const CImg<float>& iNF,const CImg<float>& iF)const{
	// La imagen J que devolvemos
 ...
 * @ToDo: usar Fast Bilateral Filter.
 */
CImg<float>& Decoupling::crossBilateralFilterAlt(const CImg<float>& iNF,const CImg<float>& iF)const{
	// La imagen J que devolvemos
	CImg<float>* J = new CImg<float>(iNF,false);
 ...
 */
CImg<>& Decoupling::gaussianKernel(const int size, const float sigma){
 ...
 */
CImg<>& Decoupling::piecewiseBilateralFilter(const CImg<float>& I)const{
	cerr << "Decoupling::piecewiseBilateralFilter()" << endl;
	// La imagen J que devolvemos
